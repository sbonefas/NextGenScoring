...
class TestShotCodes2(unittest.TestCase):
    ...
    def free_throw(self, player, made, rebounded, off_rb, player2):
        __class__.driver.find_element_by_id("userinput").send_keys("E")
        __class__.driver.find_element_by_id("userinput").send_keys(player)
        ...
        if made:  
            ...
            if rebounded:
                ...
                if off_rb:
                    __class__.driver.find_element_by_id("userinput").send_keys(player2)
                else:
    ...
    def test_def_bench_foul(self):
        print("test_def_bench_foul")
        self.home_on_offense()
        
        tf2_before = __class__.driver.find_element_by_id("visitor").find_element_by_class_name("fouls-top").find_element_by_xpath('h3[2]').text
        tf_before = __class__.driver.find_element_by_id("ps-visitor").find_element_by_xpath("table/tbody/tr[12]/td[13]").text
        to_before = __class__.driver.find_element_by_id("ps-visitor").find_element_by_xpath("table/tbody/tr[12]/td[12]").text
        to_before2 = __class__.driver.find_element_by_id('ps-visitor').find_element_by_xpath('div/p[2]').text.split(' ')[2]
        
        self.bench_foul("V")
        
        tf2_after = __class__.driver.find_element_by_id("visitor").find_element_by_class_name("fouls-top").find_element_by_xpath('h3[2]').text
        tf_after = __class__.driver.find_element_by_id("ps-visitor").find_element_by_xpath("table/tbody/tr[12]/td[13]").text
        to_after = __class__.driver.find_element_by_id("ps-visitor").find_element_by_xpath("table/tbody/tr[12]/td[12]").text
        to_after2 = __class__.driver.find_element_by_id('ps-visitor').find_element_by_xpath('div/p[2]').text.split(' ')[2]
        
        self.assertEqual(int(tf_after), int(tf_before) + 1, "Total team fouls")
        self.assertEqual(int(tf2_after), int(tf2_before) + 1, "Total team fouls - scoreboard")
        self.assertEqual(int(to_after), int(to_before), "Total team turnovers")
        self.assertEqual(int(to_after2), int(to_before2), "Total team turnovers - lower")
 
    # ## PENDING OFFENSIVE INCREMENT TEAM FOULS IN BANNER BUG ##
    # def test_off_bench_foul(self):
        # print("test_off_bench_foul")
        # self.home_on_offense()
        
        # tf2_before = __class__.driver.find_element_by_id("home").find_element_by_class_name("fouls-top").find_element_by_xpath('h3[2]').text
        # tf_before = __class__.driver.find_element_by_id("ps-home").find_element_by_xpath("table/tbody/tr[12]/td[13]").text
        # to_before = __class__.driver.find_element_by_id("ps-home").find_element_by_xpath("table/tbody/tr[12]/td[12]").text
        # to_before2 = __class__.driver.find_element_by_id('ps-home').find_element_by_xpath('div/p[2]').text.split(' ')[2]
        # home_color = __class__.driver.find_element_by_id("homescoreshowhide").get_attribute("style").split(';')[0].split(' ')[1]
        
        # self.bench_foul("H")
        
        # tf2_after = __class__.driver.find_element_by_id("home").find_element_by_class_name("fouls-top").find_element_by_xpath('h3[2]').text
        # tf_after = __class__.driver.find_element_by_id("ps-home").find_element_by_xpath("table/tbody/tr[12]/td[13]").text
        # to_after = __class__.driver.find_element_by_id("ps-home").find_element_by_xpath("table/tbody/tr[12]/td[12]").text
        # to_after2 = __class__.driver.find_element_by_id('ps-home').find_element_by_xpath('div/p[2]').text.split(' ')[2]
        ...
        # self.assertEqual(int(tf_after), int(tf_before), "Total team fouls")
        # ## PENDING BUGS ##
        # #self.assertEqual(int(tf2_after), int(tf2_before) + 1, "Total team fouls - scoreboard")
        # self.assertEqual(int(to_after), int(to_before) + 1, "Total team turnovers")
        # self.assertEqual(int(to_after2), int(to_before2) + 1, "Total team turnovers - lower") 
    ...
    ## BUG PENDING ##
    # def test_off_tech_foul(self):
        # print("test_off_tech_foul")
        # self.home_on_offense()
        
        # tf2_before = __class__.driver.find_element_by_id("home").find_element_by_class_name("fouls-top").find_element_by_xpath('h3[2]').text
        # tf_before = __class__.driver.find_element_by_id("ps-home").find_element_by_xpath("table/tbody/tr[12]/td[13]").text
        # pf_before = __class__.driver.find_element_by_id("ps-home").find_element_by_xpath("table/tbody/tr[2]/td[13]").text
        # to_before = __class__.driver.find_element_by_id("ps-home").find_element_by_xpath("table/tbody/tr[12]/td[12]").text
        # to_before2 = __class__.driver.find_element_by_id('ps-home').find_element_by_xpath('div/p[2]').text.split(' ')[2]
        ...
        # tf2_after = __class__.driver.find_element_by_id("home").find_element_by_class_name("fouls-top").find_element_by_xpath('h3[2]').text
        # tf_after = __class__.driver.find_element_by_id("ps-home").find_element_by_xpath("table/tbody/tr[12]/td[13]").text
        # pf_after = __class__.driver.find_element_by_id("ps-home").find_element_by_xpath("table/tbody/tr[2]/td[13]").text
        # to_after = __class__.driver.find_element_by_id("ps-home").find_element_by_xpath("table/tbody/tr[12]/td[12]").text
        # to_after2 = __class__.driver.find_element_by_id('ps-home').find_element_by_xpath('div/p[2]').text.split(' ')[2]
        
        # #self.assertEqual(int(tf2_after), int(tf2_before) + 1, "Team fouls - banner")
        # #self.assertEqual(int(tf_after), int(tf_before) + 1, "Team fouls")
        # self.assertEqual(int(pf_after), int(pf_before) + 1, "Personal foul")
        # self.assertEqual(int(to_after), int(to_before) + 1, "Turnover")
        # self.assertEqual(int(to_after2), int(to_before2) + 1, "Turnover-2")
        
    
    def test_def_tech_foul(self):
        print("test_def_tech_foul")
        self.home_on_offense()
    ...
    def test_missed_free_throw_off(self):
        ## ASSUME HOME TEAM IS ON OFFENSE ##
        self.resetClass()
        self.home_on_offense()
    ...
    ## PENDING FTA GOES TO WRONG TEAM BUG ##
    # def test_missed_free_throw_def(self):
        # # DEFENSIVE REBOUND
        # for i in range(0,10):
            # self.home_on_offense()
            # tp_before = __class__.driver.find_element_by_id("ps-home").find_element_by_xpath("table/tbody/tr[2]/td[14]").text
